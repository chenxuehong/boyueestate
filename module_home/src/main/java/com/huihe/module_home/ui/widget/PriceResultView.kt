...
import com.kotlin.base.widgets.NoTouchRecyclerView

private var minPrice = "0"

private val prices =
    mutableListOf<String>("不限", "200万以下", "200-300万", "300-400万", "400-500万", "500-800万", "800-1000万")
...
fun View.initPriceView(
    ...
    tvSure.setOnClickListener {
        ...
        var priceRanges = getRealPriceRanges(etMinValue.text.toString().trim(),
            etMaxValue.text.toString().trim())
        mListener?.onSearchResult(PriceResult(priceRanges[0],priceRanges[1]),SearchType.PriceType)
    }
