package com.bafuestate.message.modules.conversation;
...
import com.bafuestate.message.modules.conversation.holder.ConversationCustomHolder;
import com.bafuestate.message.modules.conversation.interfaces.IConversationAdapter;
import com.bafuestate.message.modules.conversation.interfaces.IConversationProvider;
...
import com.bafuestate.message.modules.conversation.holder.ConversationBaseHolder;
import com.bafuestate.message.modules.conversation.holder.ConversationCommonHolder;
        ...
        switch (getItemViewType(position)) {
            ...
            default:
                ...
                if (conversationInfo.isTop()) {
                    if (conversationCommonHolder.tvTop.getText().toString().equals(BaseApplication.context.getResources().getString(R.string.im_set_top))) {
                        conversationCommonHolder.tvTop.setText(BaseApplication.context.getResources().getString(R.string.im_cancel_set_top));
                    }
                } else {
                    if (conversationCommonHolder.tvTop.getText().toString().equals(BaseApplication.context.getResources().getString(R.string.im_cancel_set_top))) {
                        conversationCommonHolder.tvTop.setText(BaseApplication.context.getResources().getString(R.string.im_set_top));
                    }
                }
