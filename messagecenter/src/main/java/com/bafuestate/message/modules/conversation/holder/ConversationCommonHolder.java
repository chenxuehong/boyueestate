...
import com.bafuestate.message.modules.conversation.base.ConversationIconView;
import com.bafuestate.message.modules.message.MessageInfo;
import com.bafuestate.message.utils.DateTimeUtil;
...
public class ConversationCommonHolder extends ConversationBaseHolder {
    ...
    public ConversationCommonHolder(View itemView) {
        ...
        tvDelete = rootView.findViewById(R.id.conversation_tv_delete);
        tvTop = rootView.findViewById(R.id.conversation_tv_top);
    }
