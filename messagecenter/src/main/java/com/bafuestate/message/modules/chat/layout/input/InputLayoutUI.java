...
import com.bafuestate.message.modules.chat.interfaces.IInputLayout;
import com.bafuestate.message.modules.chat.layout.inputmore.InputMoreActionUnit;
...
//        mShortcutArea = findViewById(R.id.shortcut_area);
    ...
    protected void assembleActions() {
        ...
        if (!mCaptureDisable) {
            ...
            action.setTitleId(R.string.Take_a_picture);
            action.setOnClickListener(new OnClickListener() {
                @Override
        ...
        if (!mVideoRecordDisable) {
            ...
            action.setTitleId(R.string.camera);
            action.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    startVideoRecord();
