package com.bafuestate.message.modules.chat;
...
import com.bafuestate.message.modules.chat.base.ChatInfo;
import com.bafuestate.message.modules.chat.base.ChatManagerKit;
import com.bafuestate.message.modules.conversation.ConversationManagerKit;
import com.bafuestate.message.modules.group.apply.GroupApplyInfo;
import com.bafuestate.message.modules.group.info.GroupInfo;
import com.bafuestate.message.modules.group.info.GroupInfoProvider;
import com.bafuestate.message.modules.group.member.GroupMemberInfo;
import com.bafuestate.message.modules.message.LiveMessageInfo;
...
public class GroupChatManagerKit extends ChatManagerKit {
    ...
    public static void createGroupChat(final GroupInfo chatInfo, final IUIKitCallBack callBack) {
        ...
        v2TIMGroupInfo.setGroupID(chatInfo.getGroupID());
        v2TIMGroupInfo.setGroupAddOpt(chatInfo.getJoinType());
        v2TIMGroupInfo.setFaceUrl(chatInfo.getFaceUrl());
        ...
        V2TIMManager.getGroupManager().createGroup(v2TIMGroupInfo, v2TIMCreateGroupMemberInfoList, new V2TIMValueCallback<String>() {
            ...
            public void onError(int code, String desc) {
                if (code == 10025){
                    if (callBack != null) {
                        callBack.onSuccess(chatInfo.getGroupID());
                    }
                }else {
