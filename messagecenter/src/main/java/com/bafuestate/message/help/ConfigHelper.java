package com.bafuestate.message.help;

import android.os.Environment;

import com.kotlin.base.common.BaseApplication;
import com.bafuestate.message.TUIKit;
import com.bafuestate.message.config.CustomFaceConfig;
...
public class ConfigHelper {
    ...
    public TUIKitConfigs getConfigs() {
        ...
        config.setAppCacheDir(BaseApplication.Companion.getContext().getFilesDir().getPath());
