...
class TransactionRvAdapter(mContext: Context) :BaseRecyclerViewAdapter<CustomerRep.Customer,TransactionRvAdapter.ViewHolder>(mContext) {
    var colors :List<IntArray> = mutableListOf()
    val intArr1 = intArrayOf(R.color.common_red,R.color.common_red,R.color.common_red,R.color.common_red)
    val intArr2 = intArrayOf(R.color.tao_bg_color,R.color.tao_bg_color,R.color.tao_bg_color,R.color.tao_bg_color)
    val intArr3 = intArrayOf(R.color.color_66999999,R.color.color_66999999,R.color.color_66999999,R.color.color_66999999)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.layout_transaction_item,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.tvCustomerDemandBeat.text = item.demandBeat?:""
        holder.itemView.tvCustomerDemandFloor.text = item.demandFloor?:""
        holder.itemView.tvCustomerDemandCreateDate.text = DateUtils.stringToString(item.createDate?:"",
