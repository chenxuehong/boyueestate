...
import com.kotlin.base.widgets.picker.WheelPicker.entity.LinkageFirst;
import com.kotlin.base.widgets.picker.WheelPicker.entity.LinkageSecond;
import com.kotlin.base.widgets.picker.WheelPicker.entity.LinkageThird;
...
public class LinkagePicker<Fst extends LinkageFirst<Snd>, Snd extends LinkageSecond<Trd>, Trd> extends WheelPicker {
    ...
    public void setSelectedItem(Fst fst, Snd snd, Trd trd) {
        ...
        LogUtils.v(TAG,"init select first: " + fst.getName() + ", index:" + selectedFirstIndex);
        //noinspection unchecked
        ...
        LogUtils.v(TAG,"init select second: " + snd.getName() + ", index:" + selectedSecondIndex);
        ...
        LogUtils.v(TAG,"init select third: " + trd + ", index:" + selectedThirdIndex);
    }
    ...
    protected View makeCenterView() {
        ...
        firstView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                LogUtils.v(TAG,"change second data after first wheeled");
        ...
        secondView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                if (!provider.isOnlyTwo()) {
                    LogUtils.v(TAG,"change third data after second wheeled");
                    selectedThirdIndex = 0;//重置第三级索引
                    //noinspection unchecked
                    List<Trd> trds = provider.linkageThirdData(selectedFirstIndex, selectedSecondIndex);
                    selectedThirdItem = trds.get(selectedThirdIndex);
